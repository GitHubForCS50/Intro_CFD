...
% constants
global NPI NPJ LARGE U_IN XMAX YMAX NhJ
% variables
global x x_u y y_v u v pc p rho mu mut mueff k eps delta E E2 yplus yplus1 ...
    yplus2 yplus3 uplus tw b SP Su d_u d_v omega SMAX SAVG m_in m_out relax_u relax_v ...
    relax_pc  aP aE aW aN aS F_u F_v u_old v_old pc_old k_old ...
...
yplus3(:,:)= sqrt(rho .* u ./ mu) * (y(NhJ+1) - y(NhJ));   % yplus3
yplus(:,:) = 1.;       % yplus
tw(:,:)    = 5.;       % tw
