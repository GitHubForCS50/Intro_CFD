...
% variables
global x x_u y y_v u p mu SP Su F_u F_v d_u relax_u u_old rho Istart Iend ...
    Jstart Jend b aE aW aN aS aP dudx dvdx
...
for I = Istart:Iend
    ...
    for J = Jstart:Jend
        ...
        Su(i,J) = ((mu(I,J)*dudx(I,J)-mu(I-1,J)*dudx(I-1,J))/(x(I)-x(I-1)) ...
                  + (mun*dvdx(i,j+1)-mus*dvdx(i,j))/(y_v(j+1)-y_v(j)))*AREAw*AREAs;
